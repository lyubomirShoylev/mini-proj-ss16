...
\begin{table}[!htbp]
    ...
    \end{tabular}
    \caption{Table of the connection between Siegbahn and IUPAC notation. IUPAC levels are listed with atomic notation as well. Source: \cite{Jenkins1991}.}
