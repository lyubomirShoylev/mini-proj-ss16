...
We have previously determined the composition of the semiconductor samples by measuring the lattice constant \reminder{cite non-mp}. Here, we will provide an independent confirmation of these results, as well as measure the relative composition.
\begin{figure}[!htbp]
    \centering
